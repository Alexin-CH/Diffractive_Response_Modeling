...
from models.conv import ConvFieldPredictor
...
def main():
    ...
    child_model = ConvFieldPredictor(in_ch=fp_ch, hidden=fp_hidden, out_ch=fp_ch)
    parent_model = LinearModel(in_ch=parent_in_ch, hidden=parent_hidden, out_ch=parent_hidden)

    # Initialize HyperNetwork and SequentialModel with corrected channel sizes
